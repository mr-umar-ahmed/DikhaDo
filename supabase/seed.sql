-- Demo data. Run ONCE on a fresh project (it is not re-runnable: categories have primary keys).
-- The 12 workers are scattered within ~4 km of HITEC City, Hyderabad. To move them to the venue
-- later, do not edit this file - run this in the SQL editor (needs migration 0003):
--   select move_demo_workers(<venue lat>, <venue lng>);
